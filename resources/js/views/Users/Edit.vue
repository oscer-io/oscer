<template>
    <layout :title="$t('users.edit_page_title', {name: user.name, id: user.id} )">
        <div>
                ...
                <div class="mt-8 border-t border-gray-200 pt-5">
                    <div class="flex justify-end">
                        <span class="inline-flex rounded-md shadow-sm">
                            <InertiaLink :href="route('cms.backend.users.show',{user: user.id})"
...
<script>
    ...
    export default {
        ...
        methods: {
            submit() {
                this.$inertia.put(this.route('cms.backend.users.update',{user: this.user.id}), this.form);
            }
        }
    }
</script>
